...
def GetDataFromNews(url,title):
    ...
    if news_response.status_code == 200:
        ...
        array = np.array([datetime.datetime.now(), url, title, subtitle, location, publish_date, publish_hour, 
...
# Set Export csv Path
export_path = r"C:/Users/Oriol/Desktop/CurrentNews.csv"

# Set csv Headers
csv_header = np.array(
        ["extraction_date","url", "title", "subtitle", "location", "publish_date", "publish_hour", 
         "last_update_date", "last_update_hour", "tag", "num_tags"])
